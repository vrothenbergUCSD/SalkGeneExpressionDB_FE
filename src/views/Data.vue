    ...
    <div class="w-11/12 mx-auto">
        ...
        <div id="left-panels" class="col-12">
          <div class="p-fluid grid formgrid">
            <div class="field col-7 pr-2">
              ...
              <InputText v-model="experiment" type="text" class="w-full mb-2"
                :class="{ 'p-invalid': experimentInvalid }" />
            ...
            <div class="field col-3">
              ...
              <InputNumber v-model="year" mode="decimal" :useGrouping="false" class="w-full mb-2"
                :class="{ 'p-invalid': yearInvalid }" />
          ...
          <div class="p-fluid grid">
            <div class="field col-7 pr-2">
              ...
              <InputText v-model="institution" type="text" class="w-full mb-2"
                :class="{ 'p-invalid': institutionInvalid }" />
      ...
      <div id="gene_metadata">
        ...
        <div class="flex items-center content-center my-1">
          ...
          <div class="ml-5">
            <FileUpload :class="{ 'p-button-warning': upload_gene_metadata_highlight }" mode="basic"
              name="upload_gene_metadata" :chooseLabel="upload_gene_metadata_filename" :auto="true" :customUpload="true"
              accept=".csv" :maxFileSize="100000000" @uploader="upload_gene_metadata" />
          </div>
        </div>
      ...
      <div id="sample_metadata">
        ...
        <div class="flex items-center content-center my-1">
          ...
          <div class="ml-5">
            <FileUpload :class="{ 'p-button-warning': upload_sample_metadata_highlight }" mode="basic"
              name="upload_sample_metadata" :chooseLabel="upload_sample_metadata_filename" :auto="true"
              :customUpload="true" accept=".csv" :maxFileSize="100000000" @uploader="upload_sample_metadata" />
        ...
        <div class="flex items-center content-center my-1">
          ...
          <div class="ml-5">
            <FileUpload mode="basic" :class="{ 'p-button-warning': upload_gene_metadata_highlight }"
              name="upload_gene_expression_data" :chooseLabel="upload_gene_expression_data_filename" :auto="true"
              :customUpload="true" accept=".csv" :maxFileSize="100000000" @uploader="upload_gene_expression_data" />
          </div>
        </div>
